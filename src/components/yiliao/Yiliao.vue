    ...
    methods: {
      ...
      this.gridDomain = row.domain;
        this.pageLoading = true;
          this.$http.get('/api/web/baidutg/start/yiliao_wxlist.php',{params:{domain:row.domain}}).then(res => {
      ...
      resetLinkPage(e) {
        this.pageLoading = true;
          this.$http.get('/api/web/baidutg/start/yiliao_wxlist.php',{params:{domain:e}}).then(res => {
            this.gridData = res.data;
             this.pageLoading = false;
        })
      },
      ...
      onSubmit(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
          this.$http.post("/api/web/baidutg/start/yiliao_changewx.php",
          ...
          this.$http.post("/api/web/baidutg/start/yiliao_changewxlog.php",
          qs.stringify(this.ruleForm),
          {emulateJSON: true})
      ...
      open() {
          ...
          //添加新资质
          this.$http.post("/api/web/baidutg/start/yiliao_add.php",
        ...
        opencc() {
           ...
           //添加新页面
          this.$http.post("/api/web/baidutg/start/yiliao_add_wxlist.php",
      ...
      findCompanyList(){
        //请求资质列表
      this.$http.get('/api/web/baidutg/start/yiliao.php').then(res => {
